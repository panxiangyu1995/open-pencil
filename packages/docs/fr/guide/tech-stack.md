...
| Technologie | Objectif | Statut |
|-----------|---------|--------|
| CSS Grid dans Yoga | Auto layout basé sur une grille | Livré via [fork Yoga](https://github.com/open-pencil/yoga/tree/grid) (`@signal-forge/yoga-layout`) |
