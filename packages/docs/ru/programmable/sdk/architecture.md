...
description: Структура папок, границы публичного API и паттерны компоновки в @signal-forge/vue.
---

# Архитектура SDK

`@signal-forge/vue` — Vue-слой поверх `@signal-forge/core`.
...
Если кусок логики можно переиспользовать в другом приложении на базе SignalForge без привнесения стилей — скорее всего, ему место в `@signal-forge/vue`.
