---
title: Компоненты
description: Справочник компонентов — headless-примитивы Vue в @signal-forge/vue.
---

# Компоненты

`@signal-forge/vue` предоставляет headless-структурные примитивы для подключения холста, навигационного UI, панелей свойств и специализированных элементов ввода.
