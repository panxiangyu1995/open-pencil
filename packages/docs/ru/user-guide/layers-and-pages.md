...
description: Управление слоями, страницами и панелью свойств в SignalForge.
---
...
- **SignalForge JSX** — дерево компонентов, совместимое с `renderJsx()` для программного двустороннего преобразования
