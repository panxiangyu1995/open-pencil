---
title: Components
description: Component reference for headless Vue primitives in @signal-forge/vue.
---

# Components

`@signal-forge/vue` exposes headless structural primitives for canvas wiring, navigation UI, property panels, and focused input controls.
