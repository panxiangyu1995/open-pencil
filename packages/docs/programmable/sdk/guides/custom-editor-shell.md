...
A typical SignalForge Vue app has three layers:

1. `@signal-forge/core` creates the editor
2. `@signal-forge/vue` adapts it into Vue composables and headless primitives
3. your app renders the shell, styling, and product UX

## Why this matters

The built-in SignalForge app is only one possible shell.
