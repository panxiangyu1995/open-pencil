---
title: Vue SDK
description: Build SignalForge-powered editors with headless Vue composables and primitives.
---

# Vue SDK

`@signal-forge/vue` exists so SignalForge can be more than a standalone design app.

The goal is to make SignalForge a toolkit you can embed into other products, internal tools, and workflow-specific editors — not just a single default UI.

The SignalForge app is one composition of that toolkit. The SDK is how you build a different one.
...
- **Framework-aware**: Vue integration over `@signal-forge/core`
