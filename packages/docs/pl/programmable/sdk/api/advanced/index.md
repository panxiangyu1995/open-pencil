...
Te API są publiczne, ale są bardziej wyspecjalizowane niż główna powierzchnia komponentów i kompozytów.

## Pomocniki selekcji i sceny
...
## Pomocniki kontekstu prymitywów
